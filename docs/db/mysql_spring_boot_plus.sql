...
(
    ...
    operator varchar(200) not null comment '运营商',
...
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (1, '系统管理', null, '/system/sys-user-list', 'system:management', 'el-icon-s-unfold', 1, 1, 1, 0, '1权限备注，可以查看所有用户信息', 0, '2019-10-26 11:12:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (100, '用户管理', 1, '/system/sys-user-list', 'sys:user:management', 'el-icon-s-unfold', 1, 2, 1, 0, '100权限备注，可以查看所有用户信息', 0, '2019-10-26 11:15:48', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (200, '角色管理', 1, '/system/sys-user-list', 'sys:role:management', 'el-icon-s-unfold', 1, 2, 1, 0, '200权限备注，可以查看所有用户信息', 0, '2019-10-26 11:15:48', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (300, '权限管理', 1, '/system/sys-user-list', 'sys:permission:management', 'el-icon-s-unfold', 1, 2, 1, 0, '300权限备注，可以查看所有用户信息', 0, '2019-10-26 11:15:48', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (400, '部门管理', 1, '/system/sys-user-list', 'sys:department:management', 'el-icon-s-unfold', 1, 2, 1, 0, '400权限备注，可以查看所有用户信息', 0, '2019-10-26 11:15:48', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (500, '日志管理', 1, '', 'sys:log:manager', 'el-icon-s-custom', 1, 2, 1, 0, '4005权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (1000, '用户新增', 100, '/system/sys-user-list', 'sys:user:add', 'el-icon-s-custom', 2, 3, 1, 0, '1000权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (1001, '用户修改', 100, '/system/sys-user-list', 'sys:user:update', 'el-icon-s-custom', 2, 3, 1, 0, '1001权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (1002, '用户删除', 100, '/system/sys-user-list', 'sys:user:delete', 'el-icon-s-custom', 2, 3, 1, 0, '1002权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (1003, '用户详情', 100, '/system/sys-user-list', 'sys:user:info', 'el-icon-s-custom', 2, 3, 1, 0, '1003权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (1004, '用户分页列表', 100, '/system/sys-user-list', 'sys:user:page', 'el-icon-s-custom', 2, 3, 1, 0, '1004权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (1005, '用户修改密码', 100, '/system/sys-user-list', 'sys:user:update:password', 'el-icon-s-custom', 2, 3, 1, 0, '1005权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (1006, '用户修改头像', 100, '/system/sys-user-list', 'sys:user:update:head', 'el-icon-s-custom', 2, 3, 1, 0, '1006权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (2000, '角色新增', 200, '/system/sys-user-list', 'sys:role:add', 'el-icon-s-custom', 2, 3, 1, 0, '2000权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (2001, '角色修改', 200, '/system/sys-user-list', 'sys:role:update', 'el-icon-s-custom', 2, 3, 1, 0, '2001权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (2002, '角色删除', 200, '/system/sys-user-list', 'sys:role:delete', 'el-icon-s-custom', 2, 3, 1, 0, '2002权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (2003, '角色详情', 200, '/system/sys-user-list', 'sys:role:info', 'el-icon-s-custom', 2, 3, 1, 0, '2003权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (2004, '角色分页列表', 200, '/system/sys-user-list', 'sys:role:page', 'el-icon-s-custom', 2, 3, 1, 0, '2004权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (2005, '角色列表', 200, '/system/sys-user-list', 'sys:role:list', 'el-icon-s-custom', 2, 3, 1, 0, '2005权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (2006, '角色权限ID列表', 200, null, 'sys:permission:three-ids-by-role-id', 'el-icon-s-custom', 2, 3, 1, 0, '2006权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (3000, '权限新增', 300, '/system/sys-user-list', 'sys:permission:add', 'el-icon-s-custom', 2, 3, 1, 0, '3000权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (3001, '权限修改', 300, '/system/sys-user-list', 'sys:permission:update', 'el-icon-s-custom', 2, 3, 1, 0, '3001权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (3002, '权限删除', 300, '/system/sys-user-list', 'sys:permission:delete', 'el-icon-s-custom', 2, 3, 1, 0, '3002权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (3003, '权限详情', 300, '/system/sys-user-list', 'sys:permission:info', 'el-icon-s-custom', 2, 3, 1, 0, '3003权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (3004, '权限分页列表', 300, '/system/sys-user-list', 'sys:permission:page', 'el-icon-s-custom', 2, 3, 1, 0, '3004权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (3005, '权限所有列表', 300, '/system/sys-user-list', 'sys:permission:all:menu:list', 'el-icon-s-custom', 2, 3, 1, 0, '3005权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (3006, '权限所有树形列表', 300, '/system/sys-user-list', 'sys:permission:all:menu:tree', 'el-icon-s-custom', 2, 3, 1, 0, '3006权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (3007, '权限用户列表', 300, '/system/sys-user-list', 'sys:permission:menu:list', 'el-icon-s-custom', 2, 3, 1, 0, '3007权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (3008, '权限用户树形列表', 300, '/system/sys-user-list', 'sys:permission:menu:tree', 'el-icon-s-custom', 2, 3, 1, 0, '3008权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (3009, '权限用户代码列表', 300, '/system/sys-user-list', 'sys:permission:codes', 'el-icon-s-custom', 2, 3, 1, 0, '3009权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (4000, '部门新增', 400, '/system/sys-user-list', 'sys:department:add', 'el-icon-s-custom', 2, 3, 1, 0, '4000权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (4001, '部门修改', 400, '/system/sys-user-list', 'sys:department:update', 'el-icon-s-custom', 2, 3, 1, 0, '4001权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (4002, '部门删除', 400, '/system/sys-user-list', 'sys:department:delete', 'el-icon-s-custom', 2, 3, 1, 0, '4002权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (4003, '部门详情', 400, '/system/sys-user-list', 'sys:department:info', 'el-icon-s-custom', 2, 3, 1, 0, '4003权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (4004, '部门分页列表', 400, '/system/sys-user-list', 'sys:department:page', 'el-icon-s-custom', 2, 3, 1, 0, '4004权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (4005, '部门列表', 400, '/system/sys-user-list', 'sys:department:list', 'el-icon-s-custom', 2, 3, 1, 0, '4005权限备注，可以查看所有用户信息', 1, '2019-10-26 11:18:40', '2020-03-09 00:50:13');
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (4006, '部门树形列表', 400, null, 'sys:department:all:tree', 'el-icon-s-custom', 2, 3, 1, 0, '4006权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);

INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (233, 1, 3008, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (234, 1, 1, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (235, 1, 3009, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (236, 1, 200, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (237, 1, 2000, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (238, 1, 400, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (239, 1, 2001, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (240, 1, 2002, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (241, 1, 2003, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (242, 1, 2004, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (243, 1, 2005, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (244, 1, 4000, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (245, 1, 4001, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (246, 1, 4002, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (247, 1, 4003, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (248, 1, 100, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (249, 1, 4004, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (250, 1, 4005, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (251, 1, 1000, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (252, 1, 1001, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (253, 1, 1002, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (254, 1, 1003, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (255, 1, 1004, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (256, 1, 300, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (257, 1, 1005, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (258, 1, 1006, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (259, 1, 3000, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (260, 1, 3001, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (261, 1, 3002, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (262, 1, 3003, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (263, 1, 3004, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (264, 1, 3005, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (265, 1, 3006, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (266, 1, 3007, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (267, 1, 500, 1, null, 0, '2020-03-03 14:19:18', null);
INSERT INTO sys_role_permission (id, role_id, permission_id, state, remark, version, create_time, update_time) VALUES (268, 1, 2006, 1, null, 0, '2020-03-03 14:19:18', null);
...
INSERT INTO sys_login_log (id, request_id, username, ip, area, token, type, success, code, exception_message, user_agent, browser_name, browser_version, engine_name, engine_version, os_name, platform_name, mobile, device_name, device_model, remark, create_time, update_time) VALUES (1, '1242813712335691777', 'admin', '127.0.0.1', '本机地址', 'c87aaffa35dadafb066cf18679eab36e', 1, 1, 200, null, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.149 Safari/537.36', 'Chrome', '80.0.3987.149', 'Webkit', '537.36', 'OSX', 'Mac', 0, null, null, null, '2020-03-25 22:01:11', null);
INSERT INTO sys_login_log (id, request_id, username, ip, area, token, type, success, code, exception_message, user_agent, browser_name, browser_version, engine_name, engine_version, os_name, platform_name, mobile, device_name, device_model, remark, create_time, update_time) VALUES (2, '1242813887884091393', 'admin', '127.0.0.1', '本机地址', 'c87aaffa35dadafb066cf18679eab36e', 2, 1, 200, null, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.149 Safari/537.36', 'Chrome', '80.0.3987.149', 'Webkit', '537.36', 'OSX', 'Mac', 0, null, null, null, '2020-03-25 22:01:48', null);
INSERT INTO sys_login_log (id, request_id, username, ip, area, token, type, success, code, exception_message, user_agent, browser_name, browser_version, engine_name, engine_version, os_name, platform_name, mobile, device_name, device_model, remark, create_time, update_time) VALUES (3, '1242814069371625474', 'admin', '127.0.0.1', '本机地址', null, 1, 0, null, '用户名或密码错误', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.149 Safari/537.36', 'Chrome', '80.0.3987.149', 'Webkit', '537.36', 'OSX', 'Mac', 0, null, null, null, '2020-03-25 22:02:25', null);
INSERT INTO sys_login_log (id, request_id, username, ip, area, token, type, success, code, exception_message, user_agent, browser_name, browser_version, engine_name, engine_version, os_name, platform_name, mobile, device_name, device_model, remark, create_time, update_time) VALUES (4, '1242814192096960513', null, '127.0.0.1', '本机地址', null, 2, 0, null, 'token不能为空', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.149 Safari/537.36', 'Chrome', '80.0.3987.149', 'Webkit', '537.36', 'OSX', 'Mac', 0, null, null, null, '2020-03-25 22:02:54', null);

INSERT INTO sys_operation_log (id, request_id, user_id, user_name, name, ip, area, path, module, class_name, method_name, request_method, content_type, request_body, param, token, type, success, code, message, exception_name, exception_message, browser_name, browser_version, engine_name, engine_version, os_name, platform_name, mobile, device_name, device_model, remark, create_time, update_time) VALUES (2, '1242820418688049153', null, null, 'FooBar分页列表', '127.0.0.1', '本机地址', '/api/fooBar/getPageList', 'foobar', 'com.example.foobar.controller.FooBarController', 'getFooBarPageList', 'POST', 'application/json', 1, '{"pageIndex":1,"pageSize":10}', null, 7, 1, 200, '操作成功', null, null, 'Chrome', '80.0.3987.149', 'Webkit', '537.36', 'OSX', 'Mac', 0, null, null, '', '2020-03-25 22:27:33', null);
INSERT INTO sys_operation_log (id, request_id, user_id, user_name, name, ip, area, path, module, class_name, method_name, request_method, content_type, request_body, param, token, type, success, code, message, exception_name, exception_message, browser_name, browser_version, engine_name, engine_version, os_name, platform_name, mobile, device_name, device_model, remark, create_time, update_time) VALUES (1, '1242805276474634241', null, null, 'helloWorld', '127.0.0.1', '本机地址', '/api/hello/world', null, 'io.geekidea.springbootplus.system.controller.HelloWorldController', 'helloWorld', 'GET', null, 0, null, null, 0, 1, 200, '操作成功', null, null, 'Chrome', '80.0.3987.149', 'Webkit', '537.36', 'OSX', 'Mac', 0, null, null, '', '2020-03-25 21:27:22', null);
