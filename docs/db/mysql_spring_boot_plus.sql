...
INSERT INTO sys_permission (id, name, parent_id, url, code, icon, type, level, state, sort, remark, version, create_time, update_time) VALUES (4005, '部门列表', 400, '/system/sys-user-list', 'sys:department:list', 'el-icon-s-custom', 2, 3, 1, 0, '4005权限备注，可以查看所有用户信息', 0, '2019-10-26 11:18:40', null);
