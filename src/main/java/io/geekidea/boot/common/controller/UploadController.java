...
public class UploadController {
    ...
    public ApiResult<UploadVo> upload(@PathVariable(value = "type") String type,
     ...
     * @throws Exception
     */
    @PostMapping(value = "/{type}/batch", consumes = "multipart/form-data")
    @Operation(summary = "多个文件上传")
    @Permission("sys:file:upload-batch")
    public ApiResult<List<UploadVo>> uploadBatch(@PathVariable(value = "type") String type,
