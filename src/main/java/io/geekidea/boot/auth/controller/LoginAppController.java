...
public class LoginAppController {
    ...
    public ApiResult<LoginTokenVo> login(@Valid @RequestBody LoginAppDto loginAppDto, HttpServletResponse response) throws Exception {
        LoginTokenVo loginTokenVo = loginAppService.login(loginAppDto);
        // 输出token到cookie
        Cookie cookie = new Cookie(LoginConstant.APP_COOKIE_TOKEN_NAME, loginTokenVo.getToken());
    ...
    public ApiResult<LoginTokenVo> accountLogin(@Valid @RequestBody AccountLoginAppDto loginAccountAppDto, HttpServletResponse response) throws Exception {
