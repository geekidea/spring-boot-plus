...
import io.geekidea.boot.generator.config.*;
import io.geekidea.boot.generator.config.query.SpringBootPlusMySqlQuery;
import io.geekidea.boot.generator.config.query.SpringBootPlusSqlServerQuery;
